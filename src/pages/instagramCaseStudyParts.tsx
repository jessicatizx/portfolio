...
export function ResearchIteration1Shuffle() {
...
export const STORY_RING = 'linear-gradient(135deg,#f09433 0%,#e6683c 25%,#dc2743 50%,#cc2366 75%,#bc1888 100%)'
...
export const PROFILE_BANNER_W = 473
const PROFILE_BANNER_H = 1024

export function ProfileBannerScreen() {
  return (
    <img
...
export const EXPLORATION_FSI_W = 374.751
...
export function ExplorationFSIScreen({
...
export function PhoneMockup({ activeFeature = 0, activePath = 'under16', onPathComplete }: { activeFeature?: number; activePath?: 'under16' | 'over16'; onPathComplete?: () => void }) {
  // Screen slide state
...
// ── TimingAltDemo ─────────────────────────────────────────────────────────────
export function TimingAltDemo({ phoneW = 158, playing = false }: { phoneW?: number; playing?: boolean }) {
  const phoneH = Math.round(phoneW * 2);
...
export function UserAmbiguityFlowchart() {
...
// ── PhraseCloudSection ────────────────────────────────────────────────────────
export function PhraseCloudSection() {
  const phrases = [
    {
...
export function SolutionPrototype() {
